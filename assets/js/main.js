...
function toggleDDL(container){
    container.onclick = function(){
        if(document.querySelectorAll(".filter_active") && ![...document.querySelectorAll(".filter_active")].includes(this)){
    ...
    table_ddl_buttons.forEach((ddl_btn, index) => {
        ...
        ddl_btn.onclick = function(){
            ...
            table_ddl_buttons.forEach((x) => {
                if((x.lastElementChild.classList.contains("ddl_shown") || x.lastElementChild.classList.contains("ddl_shown_last")) && x != this){
...
function changeColor(){
    ...
    if (mode == 'dark') {
        ...
        //bg
        document.querySelector("body").style.backgroundImage = `url("/assets/img/background/bg_dark.webp")`;
        document.querySelector("body").style.backgroundColor = "black";
        //mode bg
        document.querySelector(".mode_container").style.backgroundColor = '#16171D';
        //footer
        document.querySelector(".upper_footer").style.backgroundColor = 'var(--darkAccent)';
        document.querySelector(".lower_footer").style.backgroundColor = 'var(--darkBasic)';
        //table rows
        ...
        if(document.querySelector("#form_container")){
            document.querySelector("#form_container").style.backgroundColor = "var(--darkBasic)"
        }
        ...
        if(document.querySelector("#specifications_ddl_label")){
            document.querySelector("#specifications_ddl_label").style.backgroundColor = "var(--darkBasic)"
        }

        //calculator sidebar bg
        if(document.querySelector("#sidebar_main")){
            document.querySelector("#sidebar_main").style.backgroundColor = "var(--darkBasic)"
        }
        ...
        if(document.querySelector("#myChart")){
            //bg
            document.querySelector("#graph_container").style.backgroundColor = "var(--darkBasic)"
        ...
        if(document.querySelector("#scam_store_articles")){
            document.querySelector("#scam_store_articles").style.backgroundColor = "var(--blackText)"
            
            //rating ddl bg
            document.querySelector("#rating_ddl").style.backgroundColor = "var(--darkBasic)"
            document.querySelectorAll(".ranking_source").forEach(x => {
                x.style.backgroundColor = "var(--darkBasic)"
            });

            //form bg
            document.querySelector(".victim_contact").style.backgroundColor = "var(--darkGrayLight)"
        }
    }
    if (mode == 'light') {
        //Colors
        ...
        //bg
        document.querySelector("body").style.backgroundImage = `url("/assets/img/background/bg_light.webp")`;
        ...
        //contact form
        if(document.querySelector("#form_container")){
            document.querySelector("#form_container").style.backgroundColor = "var(--lightModeWhite)"
        }
        ...
        //product
        if(document.querySelector("#specifications_ddl_label")){
            document.querySelector("#specifications_ddl_label").style.backgroundColor = "var(--lightModeWhite)"
        }

        //calculator sidebar bg
        if(document.querySelector("#sidebar_main")){
            document.querySelector("#sidebar_main").style.backgroundColor = "var(--lightModeWhite)"
        }
        ...
        if(document.querySelector("#myChart")){
            //bg
            document.querySelector("#graph_container").style.backgroundColor = "var(--lightModeWhite)"
        ...
        //scam store
        if(document.querySelector("#scam_store_articles")){
            document.querySelector("#scam_store_articles").style.backgroundColor = "var(--lightModeWhite)"

            //rating ddl bg
            document.querySelector("#rating_ddl").style.backgroundColor = "var(--lightModeWhite)"
            document.querySelectorAll(".ranking_source").forEach(x => {
                x.style.backgroundColor = "var(--lightModeWhite)"
            });

            //form bg
            document.querySelector(".victim_contact").style.backgroundColor = "var(--lightModeWhite)"
        }
    }
}
    ...
    if (currentScrollPosition >= breakpointHeight && !fillingTable) {
        ...
        setTimeout(() => {
            ...
            while(i>0){
                ...
                document.querySelector("#asicsTable").lastElementChild.innerHTML +=
                    `<tr>
                    <td>
                        <div class="main_cell">
...
if(document.querySelector(".faq_title_container")) {
    document.querySelectorAll(".faq_title_container").forEach(function (container) {
...
if(document.querySelector("#specifications_ddl_container")){
        document.querySelector("#specifications_ddl_label").addEventListener("click", function (){
        //smooth height transition
        if (document.querySelector("#specifications_ddl_content").classList.contains("faq_card_open")) {
            document.querySelector("#specifications_ddl_content").style.maxHeight = "0px";
            document.querySelector("#specifications_ddl_label").classList.toggle("bottom_radius_off")
        }
        else{
            document.querySelector("#specifications_ddl_content").style.maxHeight = document.querySelector("#specifications_ddl_content").scrollHeight + 32 + "px";
            document.querySelector("#specifications_ddl_label").classList.toggle("bottom_radius_off")
        }

        //class toggle
        document.querySelector("#specifications_ddl_content").classList.toggle("faq_card_open");

        //arrow rotate
        document.querySelector("#specifications_ddl_label").querySelector(".arrow_down").classList.toggle("rotate");
    })
}
...
if(document.querySelector("#calculator_table")){
    ...
    function toggleAdvancedMode(btn_pressed = false){
        ...
        if(!advanced_calculator){
            if(width >= 800){
                ...
                //phone msg hide
                document.querySelector("#no_adv_on_mobile").classList.remove("show_toggle")
                //hide basic config
                ...
                //show phone msg
                document.querySelector("#no_adv_on_mobile").classList.add("show_toggle")
                //hide basic config
    ...
    function calculateTotal(){
        ...
        document.querySelector("#gross_total").innerHTML = '$ ' + gross_total.toFixed(2);
        ...
        document.querySelector("#costs_total").innerHTML = '$ ' + costs_total.toFixed(2);
        ...
        document.querySelector("#net_total").innerHTML = '$ ' + net_total.toFixed(2);
    }
    calculateTotal();
    ...
    function removeCardAndRow(){
        //removing the card
        let id_for_removal = this.parentElement.parentElement.getAttribute("data-card-id");

        const elements_for_removal = document.querySelectorAll('[data-card-id="'+id_for_removal+'"]');
        ...
        const number_of_cards = document.querySelector("#miner_cards").childElementCount
    ...
    function quantityChange(){
        ...
        const previousValue = this.dataset.previousValue != '' ? this.dataset.previousValue : 1;
        ...
        let rows_count = table.querySelectorAll('[data-card-id="'+card_id+'"]').length;
        ...
        if(input_value != 0 && isPureNumber(input_value)){
            ...
            if(input_value < previousValue){ //lower
                ...
                while(rows_count != input_value){
                    ...
                    rows_count = table.querySelectorAll('[data-card-id="'+card_id+'"]').length;
                }
            }
            else{ //higher
        ...
        else{ // If the current value is not a pure number or 0, revert to the previous value
    ...
    function newTableRow(card_id){
        ...
        <tr data-card-id="${card_id}">
            ...
            <td class="hide-on-mobile net_cell">
                <div class="two_row_cell">
                    <span class="bold">$ <span class="value">2217.19</span> </span>
                    <span class="second_row faded">0.75 LTC</span>
                </div>
            </td>
        </tr>
    ...
    document.querySelector("#popup_details_btn").onclick = () =>{
        ...
        //Closing the popup
        document.querySelector("#details_miner_popup").classList.toggle("show_toggle");
    }
...
function ratingDdlFunctionality(){
    ...
    {
        document.querySelector("#rating_ddl").addEventListener("click", function (){
            //smooth height transition
            if (this.querySelector(".filter_ddl").classList.contains("faq_card_open")) {
                this.querySelector(".filter_ddl").style.maxHeight = "0px";
                this.classList.toggle("bottom_radius_off")
            }
            else{
                this.querySelector(".filter_ddl").style.maxHeight = this.querySelector(".filter_ddl").scrollHeight + "px";
                this.classList.toggle("bottom_radius_off")
            }
...
if(document.querySelector("#scam_store_articles")){
    document.querySelector("#article_toggler").onclick = function(){
        document.querySelector("#scam_store_articles").querySelectorAll("article").forEach((a,i)=>{
            if(i != 0){
...
if(document.querySelector("#myChart")){
    ...
    var data = {
        datasets: [
            ...
            tension: .3, // Control the curvature of the line (less = more curvy)
